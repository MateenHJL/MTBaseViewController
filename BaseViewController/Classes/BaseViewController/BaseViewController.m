...
- (void)dealloc
{
    if ([[BaseViewControllerConfigManager shareHttpConfigManager].config respondsToSelector:@selector(superDeallocWithController:)])
    {
        [[BaseViewControllerConfigManager shareHttpConfigManager].config superDeallocWithController:self];
    }
